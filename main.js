...
async function loadJournalEntries() {
  ...
  try {
    ...
    // Only update fields if user hasn't already typed something in
    if (!dreamField.value) dreamField.value = data.dream || '';
    if (!dailyField.value) dailyField.value = data.daily || '';
  } catch (err) {
